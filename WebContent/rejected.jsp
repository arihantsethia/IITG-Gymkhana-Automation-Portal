...
<body>
	...
	<center>
		<p > <strong>Following requests are rejected :</strong></p>
		...
		<tr>
			...
			<th width=10%>Rejected by Official</th>
		</tr>
		
			<%
				System.out.println(session.getAttribute("id"));
				String sql = "SELECT * FROM request WHERE origin='"+session.getAttribute("user")+"' AND status = 1";
				Connection con = null;
				Statement s = null;
				ResultSet rs = null;
				try {
