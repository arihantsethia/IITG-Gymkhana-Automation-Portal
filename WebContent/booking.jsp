...
<body>
	<%
		...
		if (name == null || Integer.valueOf(session.getAttribute("level").toString())>2) {
	...
	<font color="gray" size="3"> <font color="gray" size="3">
			...
			<form method="post" action="AddNew" class="uniForm">

				<fieldset>
					<h3>Event Approval Form</h3>

					<div class="ctrlHolder">
						<label for=""><em>*</em> Event Name</label> <input name="name"
							data-default-value="Name Of the Event" size="35" maxlength="50"
							type="text" class="textInput required" />
						<p class="formHint">Required Event Name</p>
					</div>
					<div class="ctrlHolder">
						<label for=""><em>*</em> Event Description</label>
						<textarea name="desc"
							data-default-value="Give the description of event" size="35"
							maxlength="1500" type="text" class="textInput required"></textarea>
						<p class="formHint">Required Description</p>
					</div>
					
					<div class="ctrlHolder">
						<table>
							<tr>
								<td><label for=""><em>*</em>From Date</label> <input
									name="fDate" class="dateInput required" type="date" /></td>
								<td><label for=""><em>*</em>From Time</label> <input
									name="fTime" type="time" /></td>
							</tr>
							<p class="formHint">Required Date and Time</p>
						</table>
					</div>
					<div class="ctrlHolder">
						<table>
							<tr>
								<td><label for=""><em>*</em>Till Date</label> <input
									name="tDate" id="a_number" type="date" /></td>
					...
					<div class="ctrlHolder">
						<label for=""><em>*</em> Venue</label> <select name="venue"
							...
							<optgroup label="Others">
								<option value="au">Auditorium</option>
								<option value="mau">Mini Auditorium</option>
								<option value="mch">Manas Community Hall</option>
								<option value="fch">Faculty Community Hall</option>
							</optgroup>

						</select>
						<p class="formHint">Venues</p>
					</div>
				</fieldset>
